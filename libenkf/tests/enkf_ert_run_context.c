...
void test_create() {
  ...
  bool_vector_iset( iactive , 8 , false );
  {
    ...
    ert_init_context_type * context = ert_init_context_alloc( init_fs ,  iactive , runpath_fmt , subst_list , INIT_CONDITIONAL , 13 , 0);
...
void test_create_ENSEMBLE_EXPERIMENT() {
  ...
  bool_vector_iset( iactive , 8 , false );
  {
    ...
    ert_run_context_type * context = ert_run_context_alloc_ENSEMBLE_EXPERIMENT( fs, iactive , runpath_fmt , subst_list , 7 , 0 );
