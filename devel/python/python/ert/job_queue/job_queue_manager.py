...
cwrapper.registerType("job_queue_manager", JobQueueManager)
cwrapper.registerType("job_queue_manager_obj", JobQueueManager.createPythonObject)
cwrapper.registerType("job_queue_manager_ref", JobQueueManager.createCReference)
