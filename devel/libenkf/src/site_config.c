...
bool site_config_init(site_config_type * site_config, const config_type * config) {
  ...
  if (config_item_set(config, EXT_JOB_SEARCH_PATH_KEY)){
      site_config_set_ext_job_search_path(site_config, config_get_value_as_bool(config, EXT_JOB_SEARCH_PATH_KEY));
  }
