...
class GeertsmaTest(ExtendedTestCase):
    ...
    def test_geertsma_kernel():
        ...
        with TestAreaContext("Subsidence"):
            ...
            dz = subsidence.evalGeertsma(None, "S1", receiver, youngs_modulus, poisson_ratio, seabed)
    ...
    def test_geertsma_kernel_2_source_points_2_vintages():
        ...
        with TestAreaContext("Subsidence"):
            ...
            dz1 = subsidence.evalGeertsma(None, "S1", receiver, youngs_modulus, poisson_ratio, seabed)
            np.testing.assert_almost_equal(dz1, 8.65322541521704e-07)

            dz2 = subsidence.evalGeertsma(None, "S2", receiver, youngs_modulus, poisson_ratio, seabed)
            ...
            np.testing.assert_almost_equal(dz, dz2-dz1)
